...
// QDD operations (NOTE: maybe don't need _COMPLEX versions)
static const uint64_t CACHE_QDD_PLUS                = (60LL<<40);
static const uint64_t CACHE_QDD_PLUS_COMPLEX        = (61LL<<40);
static const uint64_t CACHE_QDD_GATE                = (62LL<<40);
static const uint64_t CACHE_QDD_GATE_COMPLEX        = (63LL<<40);
static const uint64_t CACHE_QDD_CGATE               = (64LL<<40);
static const uint64_t CACHE_QDD_CGATE_COMPLEX       = (65LL<<40);
static const uint64_t CACHE_QDD_MATVEC_MULT         = (66LL<<40);
static const uint64_t CACHE_QDD_MATMAT_MULT         = (67LL<<40);
static const uint64_t CACHE_QDD_SUBCIRC             = (68LL<<40);
static const uint64_t CACHE_QDD_PROB                = (69LL<<40);
static const uint64_t CACHE_QDD_CLEAN_AMP_TABLE     = (70LL<<40);
