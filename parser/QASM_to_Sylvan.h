...
#define get_qubits(token,n_qubits,qubits) (CALL(get_qubits,token,n_qubits,qubits));
TASK_DECL_3(bool, get_qubits, char*, BDDVAR, BDDVAR*);

#define get_gateid(tokens,gate_id) (CALL(get_gateid,tokens,gate_id));
TASK_DECL_2(bool, get_gateid, char*, uint32_t*);
