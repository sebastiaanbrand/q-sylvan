...
def get_vector(qasm_file : str):
    ...
    output = subprocess.run([SIM_QASM, '--state-vector', filepath], 
...
def test_adder_n4():
    ...
    Test adder_n4.qasm
    """
    vector = get_vector('adder_n4.qasm')
...
def test_basis_change_n3():
    """
    Test basis_change_n3.qasm
    """
    vector = get_vector('basis_change_n3.qasm')
...
def test_bell_state():
    ...
    """
    vector = get_vector('bell_state.qasm')
...
def test_fredkin_n3():
    ...
    Test ghz_n4.qasm
    """
    vector = get_vector('fredkin_n3.qasm')
...
def test_qaoa_n3():
    ...
    Test qaoa_n3.qasm
    """
    vector = get_vector('qaoa_n3.qasm')
...
def test_simon_n6():
    ...
    Test simon_n6.qasm
    """
    vector = get_vector('simon_n6.qasm')
...
def test_wstate_n3():
    ...
    Test wstate_n3.qasm
    """
    vector = get_vector('wstate_n3.qasm')
