 ...
 * the QDD.
 */
QDD qdd_grover_cnf(BDDVAR n, bool* flag, BDDVAR n_answers);
#define qdd_grover_cnf_iteration(qdd,n,flag) (CALL(qdd_grover_cnf_iteration,qdd,n,flag));
TASK_DECL_3(QDD, qdd_grover_cnf_iteration, QDD, BDDVAR, bool*);
