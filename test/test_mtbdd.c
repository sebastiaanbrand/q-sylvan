...
/*
    ...
    printf("getlow(index_root_node = %"PRIu64") = %"PRIu64" == index_x1_low = %"PRIu64" \n", index_root_node, mtbdd_getlow(index_root_node), index_x1_low);
...
// <- above works
    ...
    printf("getvalue(index_x1_low) = %"PRIu64" \n", mtbdd_getvalue(index_x1_low));
...
test_mtbdd_and_abstract_plus_function()
{
    ...
    printf("index_leaf_0 = %"PRIu64" \n", index_leaf_0);
    printf("index_leaf_1 = %"PRIu64" \n", index_leaf_1);
